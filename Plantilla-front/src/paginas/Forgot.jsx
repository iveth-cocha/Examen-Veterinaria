        ...
        <>
            <div className="bg-white flex justify-center items-center w-1/2">
                ...
                <div className="md:w-4/5 sm:w-full">
                    ...
                    <small className="text-gray-400 block my-4 text-sm">No te preocupes, ingresa tus email</small>
                    ...
                    <form onSubmit={handleSubmit} >
                        ...
                        <div className="mb-1">
                            ...
                            <input type="email" placeholder="Ingresa tu email" className="block w-full rounded-md border border-gray-300 focus:border-purple-700 focus:outline-none focus:ring-1 focus:ring-purple-700 py-1 px-1.5 text-gray-500" 
                            name='email' 
